...
function Fidcheck()
{
	...
	window.open("id_check.jsp?id="+param,"window2","width=400, height=500, resizable=yes");
}
...
<p>
<p>
<form name="myform" method="post" action="register_process.jsp"  onSubmit="return Fsubmit()">
ID
